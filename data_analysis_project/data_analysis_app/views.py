...
def data_tab(request):
    ...
    if state=="1":
        ...
        df = pd.read_csv(r"C:\Users\kedha\Downloads\data_analysis_project (1)\data_analysis_project\Data\Madhya Pradesh.csv")
    elif state=="4":
...
def box_plot(request):
    ...
    default_value = 'Present_Storage_Category'
...
def exploratory_data_analysis_tab(request):
    ...
    fig_scatter = px.scatter(df, x=selected_x_feature, y=selected_y_feature, color='Area_Type',
    ...
    default_feature_pie ='reason_water_body_in_use_name2'
